						...
						<?php foreach ($pengaduan as $dp): ?>
							...
							<tr>
								...
								<td class="align-middle text-center">
									...
									<a href="<?= base_url('assets/img/img_pengaduan/') . $dp['foto2']; ?>" class="enlarge">
										<img src="<?= base_url('assets/img/img_pengaduan/') . $dp['foto2']; ?>" class="img-fluid img-w-75-hm-100" alt="<?= $dp['foto2']; ?>">
									</a>
								</td>
