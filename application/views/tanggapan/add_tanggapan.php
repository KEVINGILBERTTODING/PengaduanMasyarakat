			  	...
			  	<form action="<?= base_url('tanggapan/addTanggapan/' . $pengaduan['id_pengaduan']); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<a href="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto1']; ?>" class="enlarge">
								<img src="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto1']; ?>" class="img-fluid img-w-150" alt="<?= $pengaduan['foto1']; ?>">
							</a>
						</div>
						<div class="form-group">
							<label for="foto2">Foto</label><br>
							<a href="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto2']; ?>" class="enlarge">
								<img src="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto2']; ?>" class="img-fluid img-w-150" alt="<?= $pengaduan['foto2']; ?>">
							</a>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="id_pengaduan">Jenis</label>
							<textarea style="cursor: not-allowed;" type="text" class="form-control" disabled><?= $pengaduan['jenis']; ?></textarea>
						</div>
						<div class="form-group">
