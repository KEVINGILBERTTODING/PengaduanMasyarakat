<div id="carouselInterval" class="carousel slide mt-5 pt-3" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="3000">
      <img src="<?= base_url('assets/img/img_properties/img_carousel/profil.jpg'); ?>" class="d-block h-500 w-100">
    </div>
    <div class="carousel-item" data-interval="3000">
      <img src="<?= base_url('assets/img/img_properties/img_carousel/profil2.jpg'); ?>" class="d-block h-500 w-100">
    </div>
    <div class="carousel-item">
      <img src="<?= base_url('assets/img/img_properties/img_carousel/profil3.jpg'); ?>" class="d-block h-500 w-100">
    </div>
  </div>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	  <div class="container">
	    <a class="navbar-brand" href="<?= base_url(); ?>">
	      <img src="<?= base_url('assets/img/img_properties/logocilik.png' ); ?>" class="d-inline-block align-top img-fluid img-w-100" style="width:10px;height:60px;>
	    </a>
...
<main class="flex-shrink-0">
	<div class="container pb-5">
		<div class="row justify-content-center py-4">
			<div class="col-lg">
				<h4>Tata Cara Penggunaan Pengaduan</h4>
		...
		<div class="row py-4" id="tentang">
			<div class="col-lg">
				<h4>Tentang</h4>
				<p>Website Pengaduan adalah pengelolaan pengaduan pelayanan publik di daerah Kabupaten Grobogan, setiap organisasi penyelenggara di Indonesia belum terkelola secara efektif dan terintegrasi. Masing-masing organisasi penyelenggara mengelola pengaduan secara parsial dan tidak terkoordinir dengan baik oleh Dinas Pekerja Umum Kabupaten Grobogan. Akibatnya terjadi duplikasi penanganan pengaduan, atau bahkan bisa terjadi suatu pengaduan tidak ditangani oleh satupun organisasi penyelenggara, dengan alasan pengaduan bukan kewenangannya. Oleh karena itu, untuk mencapai visi yang baik dan benar dalam penanganan pengaduan masyarakat maka perlu untuk mengintegrasikan sistem pengelolaan pengaduan pelayanan publik yang efektif. Tujuannya, masyarakat memiliki saluran pengaduan yang baik, benar, terorganisir dan terpercaya.</p>
			</div>
		</div>
						...
						<tbody>
							...
							<?php foreach ($pengaduan as $dp): ?>
								...
								<tr>
									...
									<td class="align-middle"><?= $dp['jenis']; ?></td>
									...
									<td class="align-middle text-center">
										<a href="<?= base_url('assets/img/img_pengaduan/') . $dp['foto1']; ?>" class="enlarge">
											<img src="<?= base_url('assets/img/img_pengaduan/') . $dp['foto1']; ?>" class="img-fluid img-w-75-hm-100" alt="<?= $dp['foto1']; ?>">
										</a>
									</td>
									<td class="align-middle text-center">
										<a href="<?= base_url('assets/img/img_pengaduan/') . $dp['foto1']; ?>" class="enlarge">
											<img src="<?= base_url('assets/img/img_pengaduan/') . $dp['foto1']; ?>" class="img-fluid img-w-75-hm-100" alt="<?= $dp['foto2']; ?>">
										</a>
									</td>
		...
		<div class="row py-4 justify-content-center" id="saran">
			<div class="col-lg-6 my-2">
				<div class="border p-3 rounded">
					<h4>Saran</h4>
					<p>Berikan saran terbaik Anda agar aplikasi Pengaduan bekerja lebih baik lagi.</p>
			...
			<div class="col-lg-6 my-2">
				<div class="border p-3 rounded">
					<h4>Peta Kabupaten Grobogan</h4>
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d363511.2778058966!2d110.7182885547749!3d-7.161821931496581!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70babb25fc5b4b%3A0x3027a76e352baf0!2sKabupaten%20Grobogan%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1665710437381!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen="" loading="lazy"></iframe>
				</div>
			</div>
		</div>
	</div>
