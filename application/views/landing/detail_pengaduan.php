...
<main class="flex-shrink-0">
	<div class="container mb-5">
		...
		<div class="row justify-content-center py-3">
			<div class="col-lg header-title">
				<h3 class="text-center"><?= $pengaduan['jenis']; ?></h3>
			</div>
		</div>
		...
		<div class="row text-center py-3">
			<div class="col-lg">
				<a href="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto1']; ?>" class="enlarge">
					<img src="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto1']; ?>" class="img-fluid img-hm-200" alt="<?= $pengaduan['foto1']; ?>">
				</a><br>
				<small>Klik gambar untuk perbesar</small>
			</div>
		</div>
		<div class="row text-center py-3">
			<div class="col-lg">
				<a href="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto2']; ?>" class="enlarge">
					<img src="<?= base_url('assets/img/img_pengaduan/') . $pengaduan['foto2']; ?>" class="img-fluid img-hm-200" alt="<?= $pengaduan['foto2']; ?>">
				</a><br>
				<small>Klik gambar untuk perbesar</small>
			</div>
		</div>
		...
		<div class="row my-3">
			<div class="col-lg">
				<table>
					...
					<tr>
						<th class="align-middle">Jenis Pengaduan</th>
						<td style="width: 3rem" class="align-middle text-center">:</td>
						<td class="align-middle"><?= $pengaduan['jenis']; ?></td>
					</tr>
					<tr>
