				...
				<div class="card">
				  ...
				  <div class="card-body">
		              ...
		              <?= form_error('no_telepon'); ?>
						  ...
						  <div class="form-group">
								<label for="NIK"><i class="fas fa-fw fa-user"></i> NIK</label>
								<input type="text" id="NIK" class="form-control <?= (form_error('NIK')) ? 'is-invalid' : ''; ?>" name="NIK" required placeholder="Masukan NIK" value="<?= set_value('NIK'); ?>">
								<div class="invalid-feedback">
		              <?= form_error('NIK'); ?>
		            </div>
							</div>
		              ...
		              <?= form_error('alamat'); ?>
							...
							<div class="form-group text-right">
								<button type="submit" class="btn btn-primary"><i class="fas fa-fw fa-save"></i> Daftar</button>
							</div>
						</form>
				  </div>
				</div>
