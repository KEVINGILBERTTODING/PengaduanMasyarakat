...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="<?= base_url('admin'); ?>" class="brand-link">
    <img src="<?= base_url('assets/img/img_properties/logogrobogan.png'); ?>" alt="AdminLTE Logo" class="img-w-50">
    <span class="brand-text">Pengaduan</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/admin/profile' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/admin/profile/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/admin' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/admin/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pengaduan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pengaduan/'
          ): ?>
        ...
        <?php if ($dataUser['jabatan'] == 'administrator'): ?>
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/user' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/user/'||
            $_SERVER['REQUEST_URI'] == '/pengaduan/kecamatan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/kecamatan/' ||
            $_SERVER['REQUEST_URI'] == '/pengaduan/kelurahan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/kelurahan/' ||
            $_SERVER['REQUEST_URI'] == '/pengaduan/masyarakat' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/masyarakat/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/laporan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/laporan/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/log' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/log/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/saran' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/saran/'
          ): ?>
