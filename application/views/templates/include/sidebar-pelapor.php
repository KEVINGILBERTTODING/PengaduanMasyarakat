  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelapor/profile' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelapor/profile/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelapor' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelapor/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporPengaduan/addPelaporPengaduan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporPengaduan/addPelaporPengaduan/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporPengaduan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporPengaduan/'
          ): ?>
        ...
        <li class="nav-item">
          <?php if (
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporLaporan' || 
            $_SERVER['REQUEST_URI'] == '/pengaduan/pelaporLaporan/'
          ): ?>
